      ...
      <section className={`${sectionBg} py-16 px-2 sm:px-4 lg:px-12 min-h-screen`}>
        <div className="max-w-5xl mx-auto mb-20 text-center">
          ...
          <p className={`text-base sm:text-lg max-w-3xl mx-auto mb-8 ${isDark ? 'text-gray-400' : 'text-gray-700'}`}>
            "Work delivered in real-world business environments, solving complex challenges with reliable solutions.
            Focused on building scalable systems that improve performance, security, and user experience."
          </p>
        </div>
